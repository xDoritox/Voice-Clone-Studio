...
class VibeVoiceASRProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        from vibevoice_asr.modular.modular_vibevoice_text_tokenizer import VibeVoiceASRTextTokenizerFast
        ...
        if os.path.exists(config_path):
            ...
            try:
                ...
                pass  # File not found - use default configuration
        ...
        if 'qwen' in language_model_pretrained_name.lower():
            # Suppress expected warning about Qwen2Tokenizer vs VibeVoiceASRTextTokenizerFast
            import warnings

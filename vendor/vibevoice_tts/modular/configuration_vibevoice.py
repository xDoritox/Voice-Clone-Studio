...
class VibeVoiceASRConfig(PretrainedConfig):
    """Configuration class for VibeVoice ASR model."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Add num_hidden_layers for transformers compatibility
        self.num_hidden_layers = getattr(self.decoder_config, 'num_hidden_layers', 32)
...
class VibeVoiceConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Add num_hidden_layers for transformers 4.57.3+ compatibility
        # This pulls from the decoder config (Qwen2Config) which has this attribute
        self.num_hidden_layers = getattr(self.decoder_config, 'num_hidden_layers', 32)

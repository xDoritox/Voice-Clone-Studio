...
class VibeVoiceASRTextTokenizerFast(Qwen2TokenizerFast):
    """
    Construct a "fast" VibeVoice ASR tokenizer (backed by HuggingFace's *tokenizers* library).
    Based on the Qwen2 tokenizer optimized for ASR transcription tasks.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._pad_id = self.pad_token_id if self.pad_token_id is not None else self._eos_id
